...
class MeetingPanelDelegate: NSObject, FloatingPanelControllerDelegate, UIGestureRecognizerDelegate {
    ...
    func floatingPanel(_ fpc: FloatingPanelController, layoutFor _: UITraitCollection) -> FloatingPanelLayout {
    ...
    func floatingPanelWillRemove(_: FloatingPanelController) {
